...
let displayCamera; // CRITICAL: Make displayCamera globally accessible
   ...
   //scene.add(circle);
    ...
    new GLTFLoader()
        ...
        .load('./scene.glb', (gltf) => {
            ...
            // CRITICAL FIX: Use global displayCamera and controls variables
...
function animate() {
    ...
    // === CAMERA FOLLOW: Keep displayCamera pointed at the avatar ===
    // if (model && displayCamera && controls) {
    //     const boneHips = model.getObjectByName("mixamorigHips");
    //     if (boneHips) {
    //         const hipPos = boneHips.position.clone();
    ...
    //
    //         displayCamera.position.lerp(targetCameraPos, cameraFollowSpeed);
    //         controls.target.lerp(hipPos, cameraFollowSpeed);
    //         controls.update();
    //     }
    // }
    ...
    if (model && displayCamera && controls) {
        ...
        if (boneHips) {
            ...
            if (adjustmentNeeded > 0) {
                ...
                displayCamera.position.lerp(targetCameraPos, adjustSpeed);
            }
